...
class AdjustedRandIndex(Metric):
    ...
    def _update(self, true_mask: torch.Tensor, pred_mask: torch.Tensor):
        ...
        """
        # np.save('gts.npy', true_mask.unflatten(1, (224, 224)).cpu().detach().numpy())
        # print('save gts', true_mask.shape)
        # np.save('pseudo_gts.npy', pred_mask.unflatten(1, (224, 224)).cpu().detach().numpy())
